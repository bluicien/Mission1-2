...
soundBtn.addEventListener("mouseover", () =>
    soundBtn.classList.add("hover-sound-btn")
);
soundBtn.addEventListener("mouseleave", () =>
    soundBtn.classList.remove("hover-sound-btn")
);
...
function soundChange() {
    ...
    const mute =
        '<i class="fa-solid fa-volume-xmark fa-xl" style="backgroundColor: white"></i>'; // Muted icon
...
const recommendationFormField = document.getElementById(
